"""Regression checks for the onyx-data-lineage-pipe casebook."""
...
from casebook.harness import assert_expected, onyx_data_lineage_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_data_lineage_pipe_summary(), assert_expected())
